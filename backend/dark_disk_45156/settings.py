"""
Django settings for dark_disk_45156 project.
...
ROOT_URLCONF = 'dark_disk_45156.urls'
...
WSGI_APPLICATION = 'dark_disk_45156.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "dark_disk_45156 API",
    "DESCRIPTION": "API documentation for dark_disk_45156 App",
    "VERSION": "v1",
}
